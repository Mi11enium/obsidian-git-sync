...
При использовании CGI, веб-сервер представляет браузеру доступ к исполняемым программам, запуская его на серверной стороне через стандартные потоки ввода и вывода.
